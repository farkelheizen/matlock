...
11. **Need legacy secret-state backfill or scanner error retries?**
   - Open: `docs/matlock-cli.md`, `docs/matlock-pipeline-specification.md`, `docs/matlock-data-model.md`
